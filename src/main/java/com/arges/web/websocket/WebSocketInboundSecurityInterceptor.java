...
public class WebSocketInboundSecurityInterceptor extends ChannelInterceptorAdapter {
    ...
    WebSocketInboundSecurityInterceptor() {
        ...
        switch (headerAccessor.getCommand()) {
            ...
            case SEND:// 沟通信息
                ...
                try {
                    ...
                    Long userId = null;
                    try {
                        userId = Long.valueOf(headerAccessor.getFirstNativeHeader("userId"));
...
//			bytePayLoad = objectMapper.writeValueAsBytes(jsonResult);
            bytePayLoad = objectMapper.writeValueAsBytes("error");
